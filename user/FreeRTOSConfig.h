...
#define configTIMER_TASK_STACK_DEPTH (configMINIMAL_STACK_SIZE*4) //软件定时器任务堆栈大小
//可选函数配置选项
...
#define configUSE_TICK_HOOK 1 //置 1：使用时间片钩子（Tick Hook）；置 0：忽略时间片钩子 //接口的适配  23
...
#define configTOTAL_HEAP_SIZE ( ( size_t ) ( 17 * 1024 ) ) //系统所有总的堆大小，从64K的RAM中分配
